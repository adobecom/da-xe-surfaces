...
const URL_SLOTS = ['ccwebstage', 'ccwebprod', 'ccdstage', 'ccdprod'];
...
/**
 * Parse SSO details string: "responseType: code | clientId:CreativeCloudWeb1 | scope:openid,creative_cloud"
...
/**
 * Parse first row as header: column 0 = shorthand, columns 1+ = slot names (ccwebstage, ccwebprod, ccdstage, ccdprod, ssodetails).
